...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/updateUser.action" id="userForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
    	 	<input type="hidden" name="flag" value="2">
			<input type="hidden" name="userId" value="${user.userId }">
			<!--  <input type="hidden" name="userCreateDate" value=<%=new Date() %>>-->
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">姓名：<input type="text" name="userName" id="username" size="20" value="${user.userName }"/></td>
		    			<td class="font3 fftd">状态：<input type="text" name="userStatus" id="status" size="20" value="${user.userStatus }"/></td>
		    		</tr>
		    			
		    		<tr>
		    			<td class="font3 fftd">登录名：<input name="loginName" id="loginname" size="20" value="${user.loginName }"/></td>
		    			<td class="font3 fftd">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：<input name="loginPwd" id="password" size="20" value="${user.loginPwd }"/></td>
		    		</tr>
