...
<body>
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <form name="empform0" method="post" id="empform0" action="${pageContext.request.contextPath}/findUserByPage.action">
		...
		<% if(pageOne!=null) {for(int i=1;i<=pageOne.getTotalPages();i++){ %>
			<a href="javascript:one(document.forms[1],<%=i%>)"><font size="3px"><%=i%>&nbsp;</font></a>
		<% }} %>
		
		<br>
		当前页${page.currentPage}/共${page.totalPages}页
		<span>跳转至</span><input type="text" name="inputPage" id="inputPage" value="${page.currentPage}" style="width:30px;text-align:center;"/>页
		<input type="button" onclick="javascript:jump_to(document.forms[1],document.getElementById('inputPage').value)" value="GO"/>
	   </form>
	  </td></tr>
	</table>
