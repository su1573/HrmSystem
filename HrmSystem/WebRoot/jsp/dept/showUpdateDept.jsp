...
<html>
	...
	function checkName(Name){
		...
		//拼写访问服务器的url
		var url = "${pageContext.request.contextPath}/findAllDept.action?deptName="+Name;
	...
	function checkNameExistCallBack(){
		...
		if(xmlHttpRequest.readyState==4 && xmlHttpRequest.status==200){
			...
			if(result == "true"){
				document.getElementById("tipInfo").innerHTML="该部门已存在";
			}else{
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/updateDept.action" id="deptForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">部门名称：<input type="text" name="deptName" id="name" onblur="checkName(this)" onfocus="clearInfo()" size="20" value="${dept.deptName }"/></td>
		    			<td><span  id="tipInfo" style="color: red;font-size: 12px"></span><br></td>
		    			<td class="font3 fftd">详细描述：<input type="text" name="deptDesc" id="remark" size="20" value="${dept.deptDesc }"/></td>
		    		</tr>
