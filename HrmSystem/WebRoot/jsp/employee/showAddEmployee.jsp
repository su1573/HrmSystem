...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/addEmployee.action" id="employeeForm" method="post">
		 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">姓名：<input type="text" name="employeeName" id="name" size="20"/></td>
		    			<td class="font3 fftd">身份证号码：<input type="text" name="employeeCardId" onblur="checkCardId(this)" onfocus="clearInfoCardId()" id="cardId" size="20"/></td>
		    		...
		    		<tr>
		    			<td class="font3 fftd">学历：<input name="employeeEducation" id="education" size="20"/></td>
		    			<td class="font3 fftd">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input name="employeeEmail" id="email" size="20"/></td>
		    		</tr>
		    		<tr>
		    			<td class="font3 fftd">手机：<input name="employeePhone" id="phone"  onblur="checkPhone(this)" onfocus="clearInfoPhone()" size="20"/></td>
			...
			<tr>
				<td class="font3 fftd">
					政治面貌：<input name="employeeParty" id="party" size="40"/>&nbsp;&nbsp;
					QQ&nbsp;&nbsp;号码：<input name="employeeQQ" id="qqNum" size="20"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					联系地址：<input name="employeeAddress" id="address" size="40"/>&nbsp;&nbsp;
					邮政编码：<input name="employeePostCode" id="postCode" size="20"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					民&nbsp;&nbsp;&nbsp;&nbsp;族：<input name="employeeRace" id="race" size="20"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					爱&nbsp;&nbsp;&nbsp;&nbsp;好：<input name="employeeHobby" id="hobby" size="20"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
